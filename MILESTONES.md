...
We have decided that we want to look at some type of crime related data for our project. Because of this we came up with the name "Crime Fighters" for our group.
 
## 2025-02-16

### Planning

Finalize what data sets we want to use and what research question we want to answer. 
Begin work on cleaning and transformation.
...
### Planning
Modeling and analysis. Further discuss what roles each person will have.
...
### Planning
We thought that a good fourth milestone would be to continue talking about our modeling plan or talking about how our data has changed over time. Some questions we thought of for the Brainstorm Dashboard milestone were 

What message are we trying to convey with it?
What type of interactive pieces do we want to have?
How do we integrate it into our project?
For the data report milestone, some questions we thought of were

Do we want to add more data to our project?
Are there any datasets we have decided not to use?
...
### Planning
What are the types of models being used?

What are the processes used to determine what hyperparameters to use?

Does everyone have a specific area to research for modelling?

Prison related variables
Quality of life
Specific crimes committed
Demographic information on people committing the crimes
...
### Planning
Some questions that we think would be good for the Dashboard sketch milestone are

Do you want your dashboard to have multiple pages/tabs?
How do you plan on adding interactive pieces?
Is there anything blocking you from including things you want to have?
...
### Finalize Dashboard Milestone
This week, our group worked on cleaning up our dashboard and our model. We reviewed the peer reviews we got back and discussed as a group what changes we wanted to make. We also started talking about what to include in our report. We started taking notes on some topics we want to cover. 
